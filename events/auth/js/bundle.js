...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar isFunction = function isFunction(input) {\n  return typeof input === 'function';\n};\n\nfunction AuthForm(_ref) {\n  var onAuth = _ref.onAuth;\n\n\n  function onSubmit(event) {\n    event.preventDefault();\n    if (isFunction(onAuth)) {\n      onAuth({ name: name, email: email, password: password });\n    }\n  }\n\n  var name = void 0;\n  var email = void 0;\n  var password = void 0;\n\n  function getName(event) {\n    name = event.currentTarget.value;\n  }\n\n  function getEmail(event) {\n    var char = event.key;\n    if (char.match('[a-zA-Z0-9@._-]') === null) {\n      event.preventDefault();\n    }\n    email = event.currentTarget.value;\n  }\n\n  function getPassword(event) {\n    var char = event.key;\n    if (char.match('[a-zA-Z0-9_]') === null) {\n      event.preventDefault();\n    }\n    password = event.currentTarget.value;\n  }\n\n  return React.createElement(\n    'form',\n    { className: 'ModalForm', action: '/404/auth/', method: 'POST', onSubmit: onSubmit },\n    React.createElement(\n      'div',\n      { className: 'Input' },\n      React.createElement('input', { required: true, id: 'name', type: 'text', placeholder: '\\u0418\\u043C\\u044F', onChange: getName }),\n      React.createElement('label', null)\n    ),\n    React.createElement(\n      'div',\n      { className: 'Input' },\n      React.createElement('input', { type: 'email', placeholder: '\\u042D\\u043B\\u0435\\u043A\\u0442\\u0440\\u043E\\u043D\\u043D\\u0430\\u044F \\u043F\\u043E\\u0447\\u0442\\u0430', onKeyDown: getEmail }),\n      React.createElement('label', null)\n    ),\n    React.createElement(\n      'div',\n      { className: 'Input' },\n      React.createElement('input', { required: true, id: 'password', type: 'password', placeholder: '\\u041F\\u0430\\u0440\\u043E\\u043B\\u044C', onKeyDown: getPassword }),\n      React.createElement('label', null)\n    ),\n    React.createElement(\n      'button',\n      { type: 'submit', onClick: onSubmit },\n      React.createElement(\n        'span',\n        null,\n        '\\u0412\\u043E\\u0439\\u0442\\u0438'\n      ),\n      React.createElement('i', { className: 'fa fa-fw fa-chevron-right' })\n    )\n  );\n}\n\nexports.default = AuthForm;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///2\n");
